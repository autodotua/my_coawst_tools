function create_clm_nc(file,time,roms_grid_info,u,v,ubar,vbar,temp,salt,zeta)
    ...
    %varid = netcdf.defVar(ncid,vancame,xtype,dimids)
    %netcdf.putAtt(ncid,varid,attncame,attrvalue)
    ...
    tempid=netcdf.inqVarID(nc,'zeta_time');
    netcdf.putVar(nc,tempid,jtime);
    tempid=netcdf.inqVarID(nc,'v2d_time');
    netcdf.putVar(nc,tempid,jtime);
    tempid=netcdf.inqVarID(nc,'v3d_time');
    netcdf.putVar(nc,tempid,jtime);
    tempid=netcdf.inqVarID(nc,'salt_time');
    netcdf.putVar(nc,tempid,jtime);
    tempid=netcdf.inqVarID(nc,'temp_time');
    netcdf.putVar(nc,tempid,jtime);
