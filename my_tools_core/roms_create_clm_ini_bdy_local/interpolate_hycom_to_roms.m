...
function roms_with_s_levels = interpolate(roms_grid_info,hycom_z,data,type,do_interp2)
    arguments
        roms_grid_info
        hycom_z(:,:,:)
        data(:,:,:)
