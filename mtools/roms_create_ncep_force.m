...
% (3) 风场强迫文件的开始时间和结束时间
time_start = datenum(start);
time_end   = datenum(stop);
...
for mm = 1:ntimes
    ...
    url = fullfile(roms_force_ncep_source_dir, ['fnl_',dd(1:8),'_',dd(10:11),'_',dd(12:13),'.grib2']);
    url=char(url);
